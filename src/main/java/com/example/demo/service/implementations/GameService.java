...
public class GameService implements IGameService {
    ...
    @Override
    public int createBoard(Board board) throws ServiceException, DaoException{
        new Board(8,8, "");
        int createdBoardId = boardDao.createBoard(board);
        if (createdBoardId < 0) {
            throw new ServiceException("BoardDao generated invalid boardId " + createdBoardId, HttpStatus.INTERNAL_SERVER_ERROR);
        }
        spaceDao.createSpaces(createdBoardId, board.getSpaces());
